...
export default handleActions({
  [ActionTypes.changePopup]: (state, {payload}) => {
    return ({
      ...
      infoMessageSentenceLemmatized: payload.infoMessageSentenceLemmatized
    });
  },
  ...
  [ActionTypes.getDataResponseChangePassword]: (state, {payload}) => ({
    ...state,
    show: payload.show,
    resetPassword: payload.resetPassword,
    text: payload.text,
